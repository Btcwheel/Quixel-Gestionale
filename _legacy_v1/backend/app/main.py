...
from app.presentation.api.external_accounts import router as external_accounts_router
...
from app.presentation.api.project_context import router as project_context_router
...
app.include_router(external_accounts_router, prefix=f"{settings.API_PREFIX}", tags=["External Accounts"])
...
app.include_router(project_context_router, prefix=f"{settings.API_PREFIX}", tags=["Project Context"])
