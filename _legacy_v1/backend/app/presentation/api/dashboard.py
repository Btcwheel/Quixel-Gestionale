...
from app.domain.models import (
    Client, Project, AIAccount, ChatLog, ExternalAccount,
    SyncLog, Alert, AdminUser
)
from app.domain.enums import ProjectStatus, SyncStatus, ExternalAccountProvider, WebhookProvider
...
async def get_dashboard_stats(
    ...
    # Deployment stats (from sync logs)
